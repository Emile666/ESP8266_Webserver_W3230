...
const char chart3_html[] PROGMEM = R"rawliteral(<html><head><title>Chart</title>
  ...
  function drawChart() {
	  var t3view = new google.visualization.DataView(data);
	  t3view.setColumns([0,1]);
      chart.draw(t3view, optionshc);}
  ...
  var optionshc =   {'height': 320,chartArea:{top:20,height:"60%%"}, hAxis:{gridlines:{color:'transparent'},
					           ticks:xTicks,slantedText: true,slantedTextAngle :70,textStyle:{fontSize: 11} },vAxis:{format:"#"},
					           series:{1:{curveType:'function'},0:{color:'red'}},legend:{position: 'none'},title:'1:Dly Heat,2:Dly Cool,3:Heat,4:Cool,5:Cool OFF, Temp.LOW,6:Heat OFF, Temp.High'};
  ...
  <h1>W3230 State Chart</h1><a href="/">Back</a><BR><BR>
