...
const char chart1_html[] PROGMEM = R"rawliteral(<html><head><title>Chart</title>
  ...
  function drawChart() {
	  var t1view = new google.visualization.DataView(data);
	  t1view.setColumns([0,1]);
      chart.draw(t1view, optionsTemp);}
  ...
  var optionsTemp = {'height': 320,chartArea:{top:20, height:"60%%"},hAxis:{gridlines:{color:'transparent'},
                     ...
                     series:{1:{curveType:'function'},0:{color:'red'}},legend:{position: 'none'},title:'T1 temperature in \260C' };
  ...
  <h1>W3230 T1 Chart</h1><a href="/">Back</a><BR><BR>
